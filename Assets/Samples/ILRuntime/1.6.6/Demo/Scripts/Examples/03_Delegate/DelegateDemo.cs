...
public class DelegateDemo : MonoBehaviour
{
    ...
    void OnHotFixProjectLoaded()
    {
        ...
        appdomain.Invoke("HotFixProject.TestDelegate", "Initialize2", null, null);
        appdomain.Invoke("HotFixProject.TestDelegate", "RunTest2", null, null);
        ...
        Debug.Log("!! OnHotFixProjectLoaded str = " + str);
