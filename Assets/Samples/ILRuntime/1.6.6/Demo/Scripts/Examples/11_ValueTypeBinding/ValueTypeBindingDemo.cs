...
public class ValueTypeBindingDemo : MonoBehaviour
{
    ...
    void RunTest()
    {
        ...
        appdomain.Invoke("HotFix.TestValueType", "RunTest", null, null);
    }
    ...
    void RunTest2()
    {
        ...
        //调用无参数静态方法，appdomain.Invoke("类名", "方法名", 对象引用, 参数列表);
        appdomain.Invoke("HotFix.TestValueType", "RunTest2", null, null);
    }
    ...
    void RunTest3()
    {
        ...
        Debug.Log("Vector2测试");
        //调用无参数静态方法，appdomain.Invoke("类名", "方法名", 对象引用, 参数列表);
        appdomain.Invoke("HotFix.TestValueType", "RunTest3", null, null);
    }
